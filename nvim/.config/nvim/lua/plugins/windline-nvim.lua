return function()
                ...
                active = {
                    space, {
                        ...
                        text = function()
                            ...
                            hi("WL_icon_tmp",
                               {guifg = color or "white", guibg = "none"})

                            return {
                                {icon, "WL_icon_tmp"}, {" "},
                                {
                                    readonly_text .. filepath,
                                    {filepath_color, "bg"}
                                }
                            }
                        end
                        ...
                        text = function(bufnr)
                            ...
                            return {{lsp_comps.lsp_name({seprator = ','})}}
                        end
                    }, space
                },
                inactive = {}
    ...
    require("wlfloatline").setup({
        interval = 300,
        ui = {active_char = "-", active_color = "blue", active_hl = nil},
