...
_G.packer_plugins = {
  ...
  ["windex.nvim"] = {
    loaded = true,
    path = "/Users/alexanderpopov/.local/share/nvim/site/pack/packer/start/windex.nvim",
