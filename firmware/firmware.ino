...
KEYMAPS(
  [WORKMAN] = KEYMAP_STACKED (
    ...
    Key_Escape,  Key_Q,  Key_D,  Key_R,  Key_W,  Key_B,  Key_Enter,
    Key_Tab,     Key_A,  Key_S,  Key_H,  Key_T,  Key_G,
    Key_LeftAlt, Key_Z,  Key_X,  Key_M,  Key_C,  Key_V,  Key_F11,
    Key_Backspace, Key_Enter, Key_Escape, Key_Spacebar,
    Key_LeftShift,

    Key_VolumeUp, Key_F6, Key_F7, Key_F8,     Key_F9,      Key_F10,   XXX,
    Key_Enter,    Key_J,  Key_F,  Key_U,      Key_P,       Key_Quote, Key_Escape,
                  Key_Y,  Key_N,  Key_E,      Key_O,       Key_I,     Key_Tab,
    Key_F12,      Key_K,  Key_L,  Key_Comma,  Key_Period,  Key_Slash, Key_RightAlt,
    Key_Backspace, Key_Enter, Key_Escape, Key_Spacebar,
    Key_RightShift
  ),
  [PURPLE] = KEYMAP_STACKED (
    ...
    XXX, TOPSY(Backslash), Key_Semicolon,   Key_Backtick,            Key_Minus,         Key_Equals,
    XXX, XXX,              Key_LeftBracket, LSHIFT(Key_LeftBracket), LSHIFT(Key_9),     XXX,        XXX,
    Key_Backspace, Key_Enter, Key_Escape, Key_Spacebar,
    Key_LeftShift,
...
void setup() {
  ...
  QUKEYS(
    ...
    kaleidoscope::plugin::Qukey(WORKMAN, KeyAddr(3, 8), Key_RightControl),
